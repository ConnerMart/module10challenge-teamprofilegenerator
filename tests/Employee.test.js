...
describe("Employee", () => {
  it("should construct an employee object with keys of name, id, and email", () => {
  ...
  it("should construct an employee object with methods of getName(), getID(), getEmail(), and getRole() that return the correct values", () => {
    const testEmployee = new Employee("testName", "testID", "testEmail");
